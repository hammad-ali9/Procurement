            ...
            <div className="auth-container">
                ...
                <div className="auth-left">
                    ...
                    <div className="auth-content-left">
                        <h1 className="auth-title-large">Login to account</h1>
                        <p className="auth-subtitle-new">Access your procurement dashboard</p>
                        ...
                        <div className="auth-footer-links">
                            <Link to="/signup">Have any account? <span className="footer-link highlight">Sign up</span></Link>
